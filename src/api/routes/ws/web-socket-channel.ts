...
export type WebSocketPayload = {
  ...
  mempoolTransaction: (transaction: any) => void;
  transaction: (transaction: any) => void;
  principalTransaction: (principal: string, transaction: any) => void;
  principalStxBalance: (principal: string, stxBalance: any) => void;
